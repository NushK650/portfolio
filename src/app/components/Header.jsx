...
function Header() {
  return (
    ...
    <div className="bg-white dark:bg-neutral-800 dark:text-white shadow py-4 px-6 fixed top-0 left-0 right-0 z-50  items-center flex justify-between text-slate-500">
