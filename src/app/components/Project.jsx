    ...
    <section id="project" className="py-16 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <p className='text-gray-500 mt-5 font-bold'>Description</p>
          <p className='text-gray-500 mt-2 font-medium max-h-25 overflow-auto'>I was assigned the task of modernizing a static website originally built using vanilla HTML, CSS, and basic JavaScript. The goal was to enhance scalability, maintainability, and performance by rebuilding the entire site from scratch using Next.js, a powerful React-based framework. Weather app rebuild | Project 
